...
function NotificationContent() {
  ...
  return (
    <div className="w-full items-center flex justify-center ">
      <div className="bg-white py-5 px-16 flex flex-col dark:bg-mediumGray xl:w-3/5 xs:w-full dark:text-white">
          ...
          {notificationDetails.map((item) => {
            return (
              <div className="md:flex flex-row gap-5">
                ...
                <div className="sm:flex px-9 md:flex flex-row gap-5">
