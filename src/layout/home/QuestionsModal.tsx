                ...
                <form onSubmit={formik.handleSubmit}>
                    <div className="mb-9">
                        ...
                        <div className='grid xl:grid-cols-4 md:grid-cols-3 xs:grid-cols-2 items-center gap-3 xl:w-[550px] md:w-[450px] p-2'>
                            {list.length > 0 &&
                                list[questionNumber].map(d => {
                                    return (
                                        <div className='flex items-center gap-2'>
                                            <input type='radio' id='selectedOption' name='selectedOption' value={d} onChange={formik.handleChange} className="xl:w-4 xl:h-4 md:w-3 md:h-3 xs:w-3 xs:h-3 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
