        ...
        <div className="w-full  ">
          ...
          >
            <Heading
              text={"Personal Info"}
              variant="subHeader"
              headingclassName=" !font-semibold tracking-wide md:text-lg  xs:text-xs sm:text-sm dark:text-white"
            />
          </NavLink>
        </div>
        <div className="w-full">
          ...
          >
            <Heading
              ...
              variant="subHeader"
              headingclassName="dark:hover:text-primaryBlue !font-semibold tracking-wide md:text-lg  xs:text-xs sm:text-sm dark:text-white"
            />
          </NavLink>
        </div>
        <div className="w-full  ">
