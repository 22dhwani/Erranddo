...
function RegistrationModal(props: { onCancel: () => void, open: boolean, onCancelAll: () => void }) {
    return (
        <>
            {props.open && (
                <Modal className="bg-slate-100 opacity-90 rounded-lg xl:w-[570px] md:w-[470px]">
                    ...
                    <div className='flex gap-5 xl:w-[550px] md:w-[450px] justify-center'>
                        <button type="button" onClick={() => props.onCancel()} className="text-black w-32 border-[#707070] border  xl:text-lg md:text-sm rounded-xl xl:h-12 lg:h-10 xs:h-10 md:px-8 xs:px-5 text-center mr-3 md:mr-0 ">Back</button>
