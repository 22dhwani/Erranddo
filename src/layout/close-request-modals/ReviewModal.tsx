                ...
                >
                    ...
                    <div className="flex flex-col items-center xl:w-[450px] md:w-[350px] xl:mt-1 md:mt-2 p-3 gap-2">
                        ...
                        <div className="pb-7 xs:w-full xl:pl-0 md:pl-3">
                            <Heading variant="headingTitle" text="TV Wall Mounting" headingclassName="xs:text-md text-center" />
                        </div>
                        <div className=" xs:w-full xl:pl-0 md:pl-3">
                            <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Write Your Review here</label>
                        ...
                        <div className="flex pb-5 xs:w-full xl:pl-0 md:pl-3 justify-center items-center gap-3">
                            ...
                            <Heading variant="smallTitle" text="I confirm the information above is accurate" headingclassName="text-slate-500 text-center xs:text-xs" />
                        </div>
